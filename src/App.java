...
public class App{
    public static void main(String[] args)   {
        ...
        //Creamos los creadores de contenido
        ...
        for (int i = 0; i < Constants.REVIEWERS.get(); i++) {
         ...
         try (FileWriter file = new FileWriter("log.txt");
                ...
                pw.printf("TIEMPO TOTAL DE EJECUCIÓN "+(fin-inicio)/1000);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        System.out.println("dataProccess: " + eventManager.getDataProcessed());
        System.out.println("dataWrited: " + eventManager.getDataWrited());
    }
